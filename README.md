...
```
The points plotted slightly larger and in orange represent Cebuano Wikipedia, were those predictions to be correct. It lands where you might expect it: among other more 'niche' Wikipedia editions.  
