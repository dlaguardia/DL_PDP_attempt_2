...
## Introduction
In this project, I wanted to investigate how different language editions of Wikipedia compare to each other, particularly in how 'large' they are based on several different measurements of their userbases, actual amounts of content, etc.
